...
function streetToRiver_init() {
    ...
    I18n.translations[I18n.locale].keyboard_shortcuts.groups['default'].members.WME_SreetToRiver_doPOI = "Create a POI from the street (StreetToRiver)";
